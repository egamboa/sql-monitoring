------------DROP TABLESPACE-----------------
PROMPT Drop TABLESPACE USUARIO
DROP TABLESPACE USUARIO INCLUDING CONTENTS;

PROMPT Drop TABLESPACE LOCALIZACION
DROP TABLESPACE LOCALIZACION INCLUDING CONTENTS;

PROMPT Drop TABLESPACE INDICES
DROP TABLESPACE INDICES INCLUDING CONTENTS;

------------CREATE TABLESPACE-----------------
PROMPT CREA TABLESPACE USUARIO
CREATE TABLESPACE USUARIO DATAFILE
'/home/oracle/hrdb/USUARIO.DBF'
SIZE 100M REUSE AUTOEXTEND OFF;

PROMPT CREA TABLESPACE LOCALIZACION
CREATE TABLESPACE LOCALIZACION DATAFILE
'/home/oracle/hrdb/LOCALIZACION.DBF'
SIZE 100M REUSE AUTOEXTEND OFF;

PROMPT CREA TABLESPACE INDICES
CREATE TABLESPACE INDICES DATAFILE
'/home/oracle/hrdb/INDICES.DBF'
SIZE 50M REUSE AUTOEXTEND OFF;
...
CREATE TABLE COUNTRIES 
    ( 
     ...
     REGION_ID NUMBER 
    ) TABLESPACE LOCALIZACION LOGGING 
;
